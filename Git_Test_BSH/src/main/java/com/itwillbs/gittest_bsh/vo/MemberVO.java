package com.itwillbs.gittest_bsh.vo;
...
-------------------------------------------------------------------------
CREATE TABLE member
	(idx	INT PRIMARI KEY AUTO_INCREMENT,
...
public class MemberVO {
	...
	//	MemberVO 객체에 email1, email2 라는 멤버변수가 필요함
	//	INSERT 과정에서 email1 과 email2 값을 결합 후 전달할 수 있다!
	//	또한, DB에서의 컬럼명은 email 이므로 조회 데이터 저장을 위해서는 
	//	만약, 뷰페이지(JSP) 에서 자바스크립트를 활용하여 email1, email2 를 email 파라미터로 결합할 경우
	//	email1, email2 멤버변수는 불필요하다!
