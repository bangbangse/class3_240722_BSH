...
파일명(board_file) - 문자열(200), NN -> 다중 파일 업로드시 사용할 컬럼
파일명(board_file1) - 문자열(200), NN -> 단일 파일 업로드시 사용할 컬럼
파일명(board_file2) - 문자열(200), NN -> 단일 파일 업로드시 사용할 컬럼
파일명(board_file3) - 문자열(200), NN -> 단일 파일 업로드시 사용할 컬럼
